import { DataField, DetailedMessage, FieldView, SimpleList, Value, FormController, Values, PageController } from '@simplity';
...
export declare class FieldElement extends BaseElement implements FieldView {
     ...
     */
    constructor(pc: PageController, fc: FormController | undefined, field: DataField, maxWidth: number, initialValue?: Value);
    resetValue(): void;

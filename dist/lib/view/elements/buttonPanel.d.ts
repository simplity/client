import { ButtonPanel, FormController, PageController } from '@simplity';
...
export declare class ButtonPanelElement extends BaseElement {
    ...
    constructor(pc: PageController, fc: FormController | undefined, panel: ButtonPanel, maxWidth: number);
}

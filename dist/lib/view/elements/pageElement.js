...
export class PageElement {
    ...
    constructor(ac, page, inputs) {
        ...
        this.fc = this.pc.fc;
        const dataPanel = new PanelElement(this.pc, this.pc.fc, this.page.dataPanel, NBR_COLS_IN_GRID);
        /**
        ...
        if (page.leftButtons || page.middleButtons || page.rightButtons) {
            ...
            const ele = elementFactory.newElement(this.pc, this.fc, buttonPanel, NBR_COLS_IN_GRID);

export declare const internalResources: {
    records: {
        _columnSelection: import("../lib").SimpleRecord;
        _filters: import("../lib").SimpleRecord;
        _reportSettings: import("../lib").SimpleRecord;
        _reportSettingsHeader: import("../lib").SimpleRecord;
        _sorts: import("../lib").SimpleRecord;
    };
    messages: {
    ...
    valueLists: import("../lib").StringMap<import("../lib").ValueList>;
    valueSchemas: import("../lib").StringMap<import("../lib").ValueSchema>;
};

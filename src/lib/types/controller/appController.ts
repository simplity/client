...
export interface AppController {
  /**
   * create a new page controller for the specified page view.
   * @param pageView for which the page controller is to be created
   */
  newPc(pageView: PageView): PageController;

  ///////////// getters for app resources  ///////////////
  /**
   * IMPORTANT:
   ...
   */
  //getCustomComp(name: string): unknown;
   ...
   */
  //getGridStyle(name?: string): GridBagStyle;
  ...
  ////////////////////  context for a conversational mode. Retain context values across page loads
  /**
